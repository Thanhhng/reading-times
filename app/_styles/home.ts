export const home = {
  view: "mx-auto max-w-[var(--content-max)] px-[var(--space-4)] pt-[var(--space-6)] pb-[var(--space-8)] @2xl/main:px-[var(--space-6)]",
  ...
  heroTitle: "mt-3 mb-2 leading-[1.05] text-[length:clamp(1.75rem,6cqi,2.75rem)]",
  heroText: "mb-[var(--space-5)] font-serif italic text-[length:var(--text-lg)] text-muted-foreground",
  heroCta: "flex flex-wrap items-center gap-3",
  heroArt: "hidden justify-center text-ink @2xl/main:flex",

  rail: "mb-[var(--space-6)] flex flex-col gap-[var(--space-3)]",
  ...
  railScroll: "grid snap-x grid-flow-col auto-cols-[184px] gap-[var(--space-4)] overflow-x-auto pb-2",

  continueCard: "flex items-center gap-[var(--space-4)] rounded-[var(--radius-lg)] border border-border bg-surface p-[var(--space-4)] shadow-[var(--shadow-sm)]",
  continueCover: "flex aspect-[3/4] w-[70px] shrink-0 items-end rounded-[var(--radius-sm)] bg-accent p-2 shadow-[var(--shadow-sm)]",
